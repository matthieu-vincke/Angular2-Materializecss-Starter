    ...
    <div class="section no-pad-bot" id="index-banner">
      <div class="container">
        ...
        <div class="row center">
          ...
          This has been built from the boiler plate for Angular2 from Google
          <a href="https://github.com/angular/quickstart" target="_blank">QuickStart</a>
        ...
        <div class="row">
          ...
          <div class="col s12 m4">
            <div class="icon-block">
              ...
              <h5 class="center">Angular2 v2.0.0!</h5>
